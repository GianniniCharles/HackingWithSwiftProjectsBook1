...
//  Project11
//
//  Created by Encompass on 5/22/19.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    var ballNames = ["ballRed",  "ballBlue", "ballYellow", "ballPurple", "ballGrey", "ballCyan", "ballGreen"]
    ...
    func makeBoxObstacle(at location: CGPoint) {
    ...
    func makeBall(at location: CGPoint) {
        guard let imageName = ballNames.randomElement() else {return}
