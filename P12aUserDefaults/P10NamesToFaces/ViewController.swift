//NOTE: This project saves data using NSCoding, which you must conform to NSObject to use. NSCoding lets you encode/decode custom swift classes to live alongside Objective-C Code and UserDefaults. Don't use Userdefaults for more than 100kb of data.
